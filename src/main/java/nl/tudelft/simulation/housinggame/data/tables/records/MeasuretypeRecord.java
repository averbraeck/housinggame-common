...
public class MeasuretypeRecord extends UpdatableRecordImpl<MeasuretypeRecord> implements Record17<Integer, String, String, String, Integer, Double, Double, Integer, Integer, Integer, Integer, Integer, Byte, Byte, Integer, Integer, Double> {
    ...
    @Override
    public Row17<Integer, String, String, String, Integer, Double, Double, Integer, Integer, Integer, Integer, Integer, Byte, Byte, Integer, Integer, Double> valuesRow() {
    ...
    @Override
    public MeasuretypeRecord value15(Integer value) {
    ...
    @Override
    public MeasuretypeRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Double value6, Double value7, Integer value8, Integer value9, Integer value10, Integer value11, Integer value12, Byte value13, Byte value14, Integer value15, Integer value16, Double value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
