...
public class MeasuretypeRecord extends UpdatableRecordImpl<MeasuretypeRecord> implements Record9<UInteger, String, String, UInteger, Integer, Integer, Integer, Byte, UInteger> {
    ...
    @Override
    public Row9<UInteger, String, String, UInteger, Integer, Integer, Integer, Byte, UInteger> valuesRow() {
    ...
    @Override
    public MeasuretypeRecord values(UInteger value1, String value2, String value3, UInteger value4, Integer value5, Integer value6, Integer value7, Byte value8, UInteger value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MeasuretypeRecord(UInteger id, String name, String description, UInteger price, Integer satisfaction, Integer pluvialProtectionLevel, Integer fluvialProtectionLevel, Byte validTillUsage, UInteger gameversionId) {
        super(Measuretype.MEASURETYPE);
