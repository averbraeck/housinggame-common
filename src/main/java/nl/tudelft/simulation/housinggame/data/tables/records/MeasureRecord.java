...
public class MeasureRecord extends UpdatableRecordImpl<MeasureRecord> implements Record5<UInteger, Double, UInteger, UInteger, UInteger> {
    ...
    @Override
    public Row5<UInteger, Double, UInteger, UInteger, UInteger> valuesRow() {
    ...
    @Override
    public MeasureRecord value5(UInteger value) {
        setHouseId(value);
        return this;
    }

    @Override
    public MeasureRecord values(UInteger value1, Double value2, UInteger value3, UInteger value4, UInteger value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MeasureRecord(UInteger id, Double value, UInteger playerroundId, UInteger measuretypeId, UInteger houseId) {
        super(Measure.MEASURE);
