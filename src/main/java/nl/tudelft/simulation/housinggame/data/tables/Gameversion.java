...
public class Gameversion extends TableImpl<GameversionRecord> {
     ...
     */
    public final TableField<GameversionRecord, Integer> LANGUAGEGROUP_ID = createField(DSL.name("languagegroup_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>housinggame.gameversion.description</code>.
     */
    public final TableField<GameversionRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "");
