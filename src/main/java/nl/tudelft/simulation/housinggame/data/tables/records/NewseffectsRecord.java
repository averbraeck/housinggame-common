...
public class NewseffectsRecord extends UpdatableRecordImpl<NewseffectsRecord> implements Record14<Integer, String, Byte, Byte, Integer, Integer, Integer, Integer, Integer, Double, Integer, Integer, Integer, Integer> {
    ...
    @Override
    public Row14<Integer, String, Byte, Byte, Integer, Integer, Integer, Integer, Integer, Double, Integer, Integer, Integer, Integer> valuesRow() {
    ...
    @Override
    public NewseffectsRecord values(Integer value1, String value2, Byte value3, Byte value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9, Double value10, Integer value11, Integer value12, Integer value13, Integer value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
