...
public class Keys {
    ...
    public static final ForeignKey<MeasureRecord, HousegroupRecord> FK_MEASURE_HOUSEROUND1 = Internal.createForeignKey(Measure.MEASURE, DSL.name("fk_measure_houseround1"), new TableField[] { Measure.MEASURE.HOUSEGROUP_ID }, Keys.KEY_HOUSEGROUP_PRIMARY, new TableField[] { Housegroup.HOUSEGROUP.ID }, true);
