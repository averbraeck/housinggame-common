...
public class Keys {
    ...
    public static final ForeignKey<HousegroupRecord, HouseRecord> FK_HOUSEGROUP_HOUSE1 = Internal.createForeignKey(Housegroup.HOUSEGROUP, DSL.name("fk_houseround_house1"), new TableField[] { Housegroup.HOUSEGROUP.HOUSE_ID }, Keys.KEY_HOUSE_PRIMARY, new TableField[] { House.HOUSE.ID }, true);
    ...
    public static final ForeignKey<MeasureRecord, HousegroupRecord> FK_MEASURE_HOUSEGROUP1 = Internal.createForeignKey(Measure.MEASURE, DSL.name("fk_measure_houseround1"), new TableField[] { Measure.MEASURE.HOUSEGROUP_ID }, Keys.KEY_HOUSEGROUP_PRIMARY, new TableField[] { Housegroup.HOUSEGROUP.ID }, true);
