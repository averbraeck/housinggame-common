...
public class Keys {
    ...
    public static final ForeignKey<MeasurecategoryRecord, GameversionRecord> FK_MEASURECATEGORY_GAMEVERSION1 = Internal.createForeignKey(Measurecategory.MEASURECATEGORY, DSL.name("fk_measurecategory_gameversion1"), new TableField[] { Measurecategory.MEASURECATEGORY.GAMEVERSION_ID }, Keys.KEY_GAMEVERSION_PRIMARY, new TableField[] { Gameversion.GAMEVERSION.ID }, true);
