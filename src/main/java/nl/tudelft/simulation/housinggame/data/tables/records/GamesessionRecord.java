...
public class GamesessionRecord extends UpdatableRecordImpl<GamesessionRecord> implements Record9<Integer, String, String, String, LocalDateTime, LocalDate, LocalDateTime, LocalDateTime, Integer> {
    ...
    @Override
    public Row9<Integer, String, String, String, LocalDateTime, LocalDate, LocalDateTime, LocalDateTime, Integer> valuesRow() {
    ...
    @Override
    public GamesessionRecord values(Integer value1, String value2, String value3, String value4, LocalDateTime value5, LocalDate value6, LocalDateTime value7, LocalDateTime value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GamesessionRecord(Integer id, String name, String password, String location, LocalDateTime createTime, LocalDate date, LocalDateTime startTime, LocalDateTime endTime, Integer gameversionId) {
        super(Gamesession.GAMESESSION);
