...
public class ScenarioRecord extends UpdatableRecordImpl<ScenarioRecord> implements Record8<Integer, String, Integer, Integer, Integer, Integer, Integer, Integer> {
    ...
    @Override
    public ScenarioRecord values(Integer value1, String value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScenarioRecord(Integer id, String name, Integer informationAmount, Integer minimumPlayers, Integer maximumPlayers, Integer highestRoundNumber, Integer scenarioparametersId, Integer gameversionId) {
        super(Scenario.SCENARIO);
