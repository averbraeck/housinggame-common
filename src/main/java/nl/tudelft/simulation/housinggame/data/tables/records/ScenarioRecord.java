...
public class ScenarioRecord extends UpdatableRecordImpl<ScenarioRecord> implements Record7<UInteger, String, Integer, UInteger, UInteger, UInteger, UInteger> {
    ...
    @Override
    public Row7<UInteger, String, Integer, UInteger, UInteger, UInteger, UInteger> valuesRow() {
    ...
    @Override
    public ScenarioRecord values(UInteger value1, String value2, Integer value3, UInteger value4, UInteger value5, UInteger value6, UInteger value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScenarioRecord(UInteger id, String name, Integer informationAmount, UInteger minimumPlayers, UInteger maximumPlayers, UInteger scenarioparametersId, UInteger gameversionId) {
        super(Scenario.SCENARIO);
