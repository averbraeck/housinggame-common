...
public class Indexes {
    ...
    public static final Index LANGUAGEGROUP_FK_LANGUAGEGROUP_LANGUAGE1_IDX = Internal.createIndex(DSL.name("fk_languages_language1_idx"), Languagegroup.LANGUAGEGROUP, new OrderField[] { Languagegroup.LANGUAGEGROUP.LANGUAGE_ID1 }, false);
    public static final Index LANGUAGEGROUP_FK_LANGUAGEGROUP_LANGUAGE2_IDX = Internal.createIndex(DSL.name("fk_languages_language2_idx"), Languagegroup.LANGUAGEGROUP, new OrderField[] { Languagegroup.LANGUAGEGROUP.LANGUAGE_ID2 }, false);
    public static final Index LANGUAGEGROUP_FK_LANGUAGEGROUP_LANGUAGE3_IDX = Internal.createIndex(DSL.name("fk_languages_language3_idx"), Languagegroup.LANGUAGEGROUP, new OrderField[] { Languagegroup.LANGUAGEGROUP.LANGUAGE_ID3 }, false);
    public static final Index LANGUAGEGROUP_FK_LANGUAGEGROUP_LANGUAGE4_IDX = Internal.createIndex(DSL.name("fk_languages_language4_idx"), Languagegroup.LANGUAGEGROUP, new OrderField[] { Languagegroup.LANGUAGEGROUP.LANGUAGE_ID4 }, false);
