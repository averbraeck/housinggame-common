...
public class Indexes {
    ...
    public static final Index MEASURECATEGORY_FK_MEASURECATEGORY_SCENARIO1_IDX = Internal.createIndex(DSL.name("fk_measurecategory_scenario1_idx"), Measurecategory.MEASURECATEGORY, new OrderField[] { Measurecategory.MEASURECATEGORY.SCENARIO_ID }, false);
