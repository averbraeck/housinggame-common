...
public class Indexes {
    ...
    public static final Index HOUSEGROUP_FK_HOUSEGROUP_HOUSE1_IDX = Internal.createIndex(DSL.name("fk_houseround_house1_idx"), Housegroup.HOUSEGROUP, new OrderField[] { Housegroup.HOUSEGROUP.HOUSE_ID }, false);
    ...
    public static final Index MEASURE_FK_MEASURE_HOUSEGROUP1_IDX = Internal.createIndex(DSL.name("fk_measure_houseround1_idx"), Measure.MEASURE, new OrderField[] { Measure.MEASURE.HOUSEGROUP_ID }, false);
