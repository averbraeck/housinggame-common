...
public class Indexes {
    ...
    public static final Index HOUSEROUND_FK_HOUSEROUND_PLAYERROUND1_IDX = Internal.createIndex(DSL.name("fk_houseround_playerround1_idx"), Houseround.HOUSEROUND, new OrderField[] { Houseround.HOUSEROUND.PLAYERROUND_ID }, false);
